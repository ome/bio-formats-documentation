...
.. list-table::
    ...
    * - `Commons Logging v1.2 <http://commons.apache.org/logging/>`_
      ...
      - `Apache License v2.0`_
    * - `NetCDF-Java Library v5.6.0 <https://docs.unidata.ucar.edu/netcdf-java/current/userguide/>`_
    ...
    * - `j2objc-annotations v2.8 <https://developers.google.com/j2objc/>`_
      ...
      - `Apache License v2.0`_
    * - `httpservices v5.6.0 <https://docs.unidata.ucar.edu/netcdf-java/current/userguide/>`_
