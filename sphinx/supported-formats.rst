...
.. list-table::
   ...
   * - :doc:`formats/targa`
     ...
     - |no|
     - |no|
   * - :doc:`formats/tecan-spark-cyto-workspace`
     - .db, .tif
     - |Very good|
     - |Very good|
     - |Good|
...
Bio-Formats currently supports **158** formats
...
.. toctree::
    ...
    formats/aim
    formats/alicona-3d
    formats/amersham-biosciences-gel
    formats/amira-mesh
    ...
    formats/applied-precision-cellworx
    formats/avi
    formats/axon-raw-format
    formats/bd-pathway
    formats/becker-hickl-fifo
    formats/becker-hickl-spcimage
    formats/big-data-viewer
    formats/bio-rad-gel
    formats/bio-rad-pic
    formats/bio-rad-scn
    formats/bitplane-imaris
    formats/bruker-mri
    formats/burleigh
    formats/canon-dng
    formats/cellh5
    formats/cellomics
    formats/cellsens-vsi
    formats/cellvoyager
    formats/cv7000
    formats/deltavision
    formats/dicom
    formats/ecat7
    formats/eps
    formats/evotecperkinelmer-opera-flex
    formats/fei
    formats/fei-tiff
    formats/fits
    formats/gatan-digital-micrograph
    formats/gatan-digital-micrograph-2
    formats/ge-microct
    formats/gif
    formats/hamamatsu-aquacosmos-naf
    formats/hamamatsu-his
    formats/hamamatsu-ndpi
    formats/hamamatsu-vms
    formats/hitachi-s-4800
    formats/i2i
    formats/ics
    formats/imacon
    formats/imagepro-sequence
    formats/imagepro-workspace
    formats/imagic
    formats/imod
    formats/improvision-openlab-liff
    formats/improvision-openlab-raw
    formats/improvision-tiff
    formats/imspector-obf
    formats/incell-1000
    formats/incell-3000
    formats/inr
    formats/inveon
    ...
    formats/jpk
    formats/jpx
    formats/keller-lab-block
    formats/khoros-viff-bitmap
    formats/kodak-bip
    formats/lambert-instruments-flim
    formats/lavision-imspector
    formats/leica-lcs-lei
    formats/leica-lif
    formats/leica-scn
    formats/leo
    formats/li-cor-l2d
    formats/lim
    formats/metamorph-75-tiff
    formats/metamorph-stack-stk
    formats/metaxpress
    formats/mias-maia-scientific
    formats/micro-manager
    formats/mikroscan-tiff
    formats/minc-mri
    formats/minolta-mrw
    formats/mng
    formats/molecular-imaging
    formats/mrc
    formats/nef
    formats/nifti
    formats/nikon-elements-tiff
    formats/nikon-ez-c1-tiff
    formats/nikon-nis-elements-nd2
    formats/nrrd
    ...
    formats/sbig
    formats/seiko
    formats/simplepci-hcimage
    formats/simplepci-hcimage-tiff
    formats/sm-camera
    formats/spider
    formats/targa
    formats/tecan-spark-cyto-workspace
    formats/text
    formats/tiff
    formats/tillphotonics-tillvision
    formats/topometrix
    formats/trestle
    formats/ubm
    formats/unisoku
    ...
    formats/ventana-bif
    formats/vg-sam
    formats/visitech-xys
    formats/volocity
    formats/volocity-library-clipping
    formats/wa-top
    formats/windows-bitmap
    formats/woolz
    formats/zeiss-axio-csm
    formats/zeiss-axiovision-tiff
