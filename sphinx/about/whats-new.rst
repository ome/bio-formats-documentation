...
* AVI
   - add support for AVI files acquired with Keyence software
* Gatan
...
* MRC
   - fixed the reading of MRC files generated with FEI EPU sfotware
* Zeiss LSM
   - improve the channel color detection for SIM data
