...
* CV7000
   - added a new reader to support the reading of Yokogawa CV7000 datasets
...
* Leica SCN
   - improve support for Vera datasets
* Micro-Manager
   - improve handling of very large :file:`*_metadata.txt` files
   - prevent ``NumberFormatException`` for invalid double values
* Metamorph
...
* OME-TIFF
   ...
   - add support for companion OME-TIFF filesets where TIFF does not link back
     to the metadata file
* PerkinElmer Operetta
   - improve support to handle datasets generated by the Harmony software
* TIFF
...
* Command-line tools
  ...
  - added ``-pyramid-scale`` and ``-pyramid-resolutions`` options to
    generate sub-resolution during conversion
  - remove ``Plate`` elements when ``-series`` is passed as an option
  - extend usage to describe available formats, extensions and compressions
