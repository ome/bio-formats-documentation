...
bioformats_source_branch = 'develop'
openmicroscopy_source_user = 'openmicroscopy'
ome_source_user = 'ome'
ome_common_version = '6.0.6'
ome_model_version = '6.2.2'
ome_model_uri = 'https://docs.openmicroscopy.org/ome-model/6.2.2'
bf_version = '6.6.0'
